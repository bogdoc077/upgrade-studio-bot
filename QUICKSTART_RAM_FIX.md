# Швидкий чеклист оптимізації RAM та трафіку

## 🚨 ПРОБЛЕМИ:
- RAM повністю зайнята (90-100%)
- Вихідний трафік ~90 ГБ/день без користувачів

## 🔧 ГОЛОВНА ПРИЧИНА:
**SQLAlchemy echo=True** логує ВСІ SQL запити → генерує 5-7 ГБ логів/день!
...
# 4. Встановити LOG_LEVEL=INFO
echo "LOG_LEVEL=INFO" >> .env

# 5. Застосувати обмеження
